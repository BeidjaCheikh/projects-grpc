...
public class BankGrpcClient5 {
        ...
        public static void main(String[] args) throws IOException {
            ...
            Bank.ConvertCurrencyRequest request =Bank.ConvertCurrencyRequest.newBuilder()
                    ...
                    .build();
            // no bloquant
            // j'envoie la requete et j'attend la reponse
            StreamObserver<Bank.ConvertCurrencyRequest> fullCurrencyStream =
                    asyncStub.fullCurrencyStream(new StreamObserver<Bank.ConvertCurrencyReponse>() {
                @Override
            ...
            timer.schedule(new TimerTask() {
                ...
                public void run() {
                    Bank.ConvertCurrencyRequest currencyRequestrequest= Bank.ConvertCurrencyRequest.newBuilder()
                            ...
                            .build();
                    fullCurrencyStream.onNext(currencyRequestrequest);
